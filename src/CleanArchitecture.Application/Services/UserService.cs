...
public class UserService : IUserService
{
  ...
  public Task<Result<string>> DisableUserAsync(UserRequest request)
  {
    throw new NotImplementedException();
  }

  public Task<Result<string>> EnableUserAsync(UserRequest request)
  {
    throw new NotImplementedException();
  }

  public Task<Result<UserProfileResponse>> GetUserProfile()
  {
    throw new NotImplementedException();
  }

  public Task<Result<UserProfileResponse>> UpdateUserProfileAsync(UpdateProfileRequest request)
  {
    throw new NotImplementedException();
  }
